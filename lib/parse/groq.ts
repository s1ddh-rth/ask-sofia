...
function systemPrompt(items: Item[], ownedTags: string[]): string {
  ...
  return [
    ...
    "",
    "job is one of: where (asking where to buy), decide (asking her to choose between options, or saying they cannot decide), cheaper (asking for a cheaper version or naming a budget), size (asking about sizing or fit), pairing (asking what to wear it with), adapt (asking to restyle it for their life or an event), worth-it (asking whether one particular piece is worth it for them), should-buy (asking about buying in general rather than one piece, for example wanting to buy less or to use what they already own), other (anything else, including compliments and messages with no question).",
    "",
    "worth-it and should-buy are easy to confuse. worth-it is about a specific piece, as in should I buy the blazer, is it worth £145, talk me out of this jacket. should-buy is about their shopping in general, as in I am trying to buy less, help me use what I own, do I need anything new at all. If a specific piece is in question it is worth-it.",
    "",
